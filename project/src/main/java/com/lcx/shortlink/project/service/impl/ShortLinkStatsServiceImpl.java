...
import com.lcx.shortlink.project.dao.entity.*;
import com.lcx.shortlink.project.dao.mapper.*;
import com.lcx.shortlink.project.dto.req.ShortLinkGroupStatsAccessRecordReqDTO;
import com.lcx.shortlink.project.dto.req.ShortLinkGroupStatsReqDTO;
import com.lcx.shortlink.project.dto.req.ShortLinkStatsAccessRecordReqDTO;
import com.lcx.shortlink.project.dto.req.ShortLinkStatsReqDTO;
import com.lcx.shortlink.project.dto.resp.ShortLinkStatsAccessDailyRespDTO;
import com.lcx.shortlink.project.dto.resp.ShortLinkStatsAccessRecordRespDTO;
import com.lcx.shortlink.project.dto.resp.ShortLinkStatsBrowserRespDTO;
import com.lcx.shortlink.project.dto.resp.ShortLinkStatsDeviceRespDTO;
import com.lcx.shortlink.project.dto.resp.ShortLinkStatsLocaleCNRespDTO;
import com.lcx.shortlink.project.dto.resp.ShortLinkStatsNetworkRespDTO;
import com.lcx.shortlink.project.dto.resp.ShortLinkStatsOsRespDTO;
import com.lcx.shortlink.project.dto.resp.ShortLinkStatsRespDTO;
import com.lcx.shortlink.project.dto.resp.ShortLinkStatsTopIpRespDTO;
import com.lcx.shortlink.project.dto.resp.ShortLinkStatsUvRespDTO;
import com.lcx.shortlink.project.service.ShortLinkStatsService;
...
public class ShortLinkStatsServiceImpl implements ShortLinkStatsService {
    ...
    public ShortLinkStatsRespDTO oneShortLinkStats(ShortLinkStatsReqDTO requestParam) {
        ...
        listTopIpByShortLink.forEach(each -> {
            ShortLinkStatsTopIpRespDTO statsTopIpRespDTO = ShortLinkStatsTopIpRespDTO.builder()
                    .ip(SM4Utils.decryptDataECB(each.get("ip").toString()))
    ...
    public ShortLinkStatsRespDTO groupShortLinkStats(ShortLinkGroupStatsReqDTO requestParam) {
        ...
        //解密
        topIpStats.forEach(each -> each.setIp(SM4Utils.decryptDataECB(each.getIp())));
    ...
    public IPage<ShortLinkStatsAccessRecordRespDTO> shortLinkStatsAccessRecord(ShortLinkStatsAccessRecordReqDTO requestParam) {
        ...
        // 解密
        linkAccessLogsDOIPage.getRecords().forEach(each -> {
            each.setIp(SM4Utils.decryptDataECB(each.getIp()));
            each.setOs(SM4Utils.decryptDataECB(each.getOs()));
            each.setBrowser(SM4Utils.decryptDataECB(each.getBrowser()));
            each.setDevice(SM4Utils.decryptDataECB(each.getDevice()));
            each.setNetwork(SM4Utils.decryptDataECB(each.getNetwork()));
            each.setLocale(SM4Utils.decryptDataECB(each.getLocale()));
        });
